...
interface PostDao {
    ...
    @Query(
        ...
        SELECT
            ...
            post.categoryKey AS categoryKey,
            post.customTagsJson AS customTagsJson,
            post.createTime AS createTime,
            post.latitude AS latitude,
            post.longitude AS longitude,
            post.country AS country,
            post.province AS province,
            post.city AS city,
            post.district AS district,
            post.locationLabel AS locationLabel,
